...
<html >
  ...
  <div class="dropdown-content">
   <a href="http://www.internshipinchennai.com/"  class="menufont">INTERNSHIP</a>
    ...
    <form method="POST" action="reg_android.php" enctype="multipart/form-data">
        ...
        <label for="year">Workshop</label><br>
  			<input type="radio" name="gender" value="Android"  readonly="readonly" checked> Android App Development<br>
        </li>
        <li>
        
        <label for="year">Date</label><br>
      	<input type="date" name="bday" max="1979-12-31" value="2016-09-17" readonly="readonly"><br>
        </li>
...
<p>This is to Confirm that you are selected to participate in the Android Application Development Workshop on September 17, 2015</p>
...
<li>The Workshop begins sharply at 09.30 AM at Main Block (conference hall)</li>
</ul>
...
//mail function
	...
	$query = mysql_query("SELECT mobile,email FROM android WHERE mobile='$mobile' or email='$email'");
  ...
  else
  {
		...
		$query="insert into android(interid,name,college,year,dept,email,mobile)
