  ...
  <div class="dropdown-content">
   <a href="http://www.internshipinchennai.com/"  class="menufont">INTERNSHIP</a>
	...
	<h1 class="title">Workshop Registration</h1>
        <form method="POST" action="reg_cloud.php" enctype="multipart/form-data">
        ...
        <label for="year">Workshop</label><br>
  			<input type="radio" name="gender" value="Android"  readonly="readonly" checked> Cloud Computing<br>
        </li>
        <li>
        
        <label for="year">Date</label><br>
      	<input type="date" name="bday" max="1979-12-31" value="2016-10-01" readonly="readonly"><br>
        </li>
...
<p>This is to Confirm that you are selected to participate in the Cloud Computing  Workshop on OCT-01, 2016</p>
...
//mail function
	...
	$query = mysql_query("SELECT mobile,email FROM cloud WHERE  email='$email'");
  ...
  else
  {
		...
		$query="insert into cloud(interid,name,college,year,dept,email,mobile)
